...
const i18n = {
  zh: {
    ...
    'svc2.title': '國防產業諮詢',
    'svc2.desc':  '專注於協助企業在高度專業且封閉的國防產業中，辨識市場機會並建立有效的商務連結，服務內容涵蓋：',
    'svc2.li1': '國防市場需求與應用場景分析',
    'svc2.li2': '市場進入策略與商業機會設計',
    'svc2.li3': '潛在需求方與合作夥伴媒合',
    'svc2.li4': '供應鏈參與模式與合作架構建議',
    'svc3.title': '市場進入策略',
  ...
  en: {
    ...
    'svc2.desc':  'Focused on helping businesses identify market opportunities and establish effective commercial connections within the highly specialized and closed defense industry. Our services include:',
    'svc2.li1': 'Defense market demand and application scenario analysis',
    'svc2.li2': 'Market entry strategy and business opportunity design',
    'svc2.li3': 'Matching with potential clients and partners',
    'svc2.li4': 'Supply chain participation models and cooperation framework recommendations',
  ...
  ja: {
    ...
    'svc2.desc':  '高度に専門的かつ閉鎖的な防衛産業において、企業が市場機会を見出し、効果的なビジネスコネクションを構築できるよう支援することに特化しています。サービス内容は以下のとおりです：',
    'svc2.li1': '防衛市場の需要と応用シナリオ分析',
    'svc2.li2': '市場参入戦略とビジネス機会の設計',
    'svc2.li3': '潜在的な需要先・パートナーとのマッチング',
    'svc2.li4': 'サプライチェーン参画モデルと協力フレームワークの提案',
    'svc3.title': '市場参入戦略',
